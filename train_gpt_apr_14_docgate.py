...
class Hyperparameters:
    ...
    # Document-boundary attention gate: restrict attention to within-document context.
    doc_attn_gate = os.environ.get("DOC_ATTN_GATE", "1") == "1"
...
def main() -> None:
    ...
    # Install the doc-attention gate: flag + the boundary LUT used to derive doc IDs.
    ...
    log0(f"doc_attn_gate:{'on' if args.doc_attn_gate else 'off'}")
